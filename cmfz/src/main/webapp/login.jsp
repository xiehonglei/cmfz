    ...
    <form id="loginForm" action="${pageContext.request.contextPath}/login" method="post">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="name" class="text" value="system" maxlength="20"/>
                </td>
            </tr>
            <tr>
                <th>
                ...
                <td>
                    <input type="password" name="password" class="password" value="123456" maxlength="20"
                           autocomplete="off"/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="enCode" name="kaptcha" class="text captcha" maxlength="4"
                           autocomplete="off"/>
                    <img id="imgVcode" class="captchaImage" src="getKaptcha" title="点击更换验证码"
